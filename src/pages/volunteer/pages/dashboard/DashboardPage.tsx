      ...
      <div className="max-w-6xl w-full py-6 space-y-6">
            ...
            {recentActivities.map((activity, index) => (
              ...
              >
                ...
                <div className="flex items-center gap-4">
                  <div className="text-sm">{activity.hours} hours</div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <Card className="shadow-md">
            <CardContent className="flex flex-col items-center justify-center p-4">
              ...
              <p className="text-sm font-medium">First Activity</p>
            </CardContent>
          </Card>
          <Card className="shadow-md">
            <CardContent className="flex flex-col items-center justify-center p-4">
              <Clock className="mb-2 text-primary" />
              <p className="text-sm font-medium">50 Hours Milestone</p>
            </CardContent>
          </Card>
          <Card className="shadow-md">
            <CardContent className="flex flex-col items-center justify-center p-4">
              <Users className="mb-2 text-primary" />
              <p className="text-sm font-medium">Consistent Volunteer</p>
            </CardContent>
          </Card>
        </div>
        ...
        <Card className="shadow-md">
          <CardContent className="p-4 text-center">
            <p className="text-sm">
              You’ve impacted <strong>6 communities</strong> and collaborated
              with <strong>4 NGOs</strong>.
            </p>
          </CardContent>
        </Card>
      </div>
